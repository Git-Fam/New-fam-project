        ...
        <div class="p-greeting__sticky">
          ...
          <div class="p-greeting__scroller" id="js-greeting-scroller">
            ...
            <div class="p-greeting__msg">
              <p>令和８年４月、甲子園学院中学校・高等学校長に<br class="pc">就任しました川崎芳徳と申します。<br>
                現在、予測困難な時代を迎え、中学校・高等学校教育には、<br class="pc">「想定外の事象と向き合い対応する力」や、<br class="pc">「不透明な未来を切り拓く力」の涵養が求められています。<br>
                このような中、本校では、校訓である<br class="pc">「黽勉努力（びんべんどりょく）」の精神により、<br class="pc">自主・自律を目指し、「決められたことを、ただ<br class="pc">守っていればよい」ではなく、道徳倫理を身につけ適切な<br class="pc">行動・選択が取れるよう人格形成に取り組んでいます。<br>
                その取組の一環として、令和８年９月から、<br class="pc">登下校時の服装について、「制服・私服併用可能期間」を<br class="pc">設定し、式典や考査等以外の日は、自身の心身の状況、<br class="pc">気候・天候、放課後のスケジュールなど、<br class="pc">ＴＰＯに応じて服装を自由に選べることとしました。<br>
                創立85年目を迎える歴史と伝統があるがゆえに、<br class="pc">「不易：時代を経ても決して変わらない、<br class="pc">普遍的な真理や本質を貫くこと」と、<br class="pc">「流行：時代や状況の移り変わり、社会のニーズに合わせて<br class="pc">新しいものを取り入れていくこと」を、<br class="pc">適切に見極めていくことが重要であると考えます。<br>
                これから、ますます発展を遂げていく<br class="pc">甲子園学院中学校・高等学校に、どうぞご注目ください！
                </p>
              </div>
            </div>
          </div>
