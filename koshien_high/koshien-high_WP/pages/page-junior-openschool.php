  ...
  <div class="high-openschool-pin">
    ...
    <section class="high-openschool-form">
      ...
      <div class="agenda-item-btn">
         <a href="https://mirai-compass.net/usr/kosiengj/event/evtIndex.jsf" target="_blank" rel="noopener noreferrer">
          <picture>
            <source media="(max-width:767px)" srcset="<?php echo get_template_directory_uri(); ?>/img/junior-openschool/junior-openschool-application-btn-sp.webp">
            <img src="<?php echo get_template_directory_uri(); ?>/img/junior-openschool/junior-openschool-application-btn-pc.webp" alt="お申込はこちら">
          </picture>
        </a>
      </div>
