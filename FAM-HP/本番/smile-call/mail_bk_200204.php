...
$title = "Entry to SMILE CALL !!";
$header = "From:FAM<info@fam-t.co.jp>\n";
$header .= "Return-Path:info@fam-t.co.jp\n";
$header .= "Reply-to:info@fam-t.co.jp\n";
$opt = '-f'.'info@fam-t.co.jp'; //送信エラーの時にエラーメールを返す先
...
mb_send_mail('info@fam-t.co.jp', 'Entry to SMILE CALL !!', $message, $header, $opt);
session_destroy();//セッション変数の破棄
