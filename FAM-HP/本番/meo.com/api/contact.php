...
$post_data_2 = $_POST['company'];
$post_data_3 = $_POST['email'];
$post_data_4 = $_POST['tel'];
$post_data_5 = $_POST['content'];


//受け取ったデータを配列に格納
$return_array = array($post_data_1, $post_data_2, $post_data_3, $post_data_4, $post_data_5);
...
mb_send_mail('marketing@fam-t.co.jp', 'MEOからお問い合わせがありました', $message2, $header, $opt);
