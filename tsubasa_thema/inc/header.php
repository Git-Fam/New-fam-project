      ...
      <nav class="header-menu-nav">
        ...
        <ul class="sub-list">
          ...
          <li class="sub-list-item sp">
                <a class="IMG" href="<?php echo esc_url(get_sns_url('instagram')); ?>" target="_blank" rel="noopener noreferrer">
...
<div class="reserve-btn front-hidden <?php if (is_front_page()): ?>is-hidden<?php endif; ?>">
  <a class="reserve-btn-inr" href="<?php echo esc_url(get_reserve_url('web_reservation')); ?>" target="_blank" rel="noopener noreferrer">
    <picture>
