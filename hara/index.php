        ...
        <div class="tracking">
            ...
            <div class="aboutoUS contact_btn--margin">
                ...
                <div class="aboutoUS__text">
                    <p>
                        埼玉・川口にて創業50年。<br class="sp">お客様に満足いただける運送を行って参りました。<br>
                        お客様のご要望やプランに最適な配送サービスを<br class="sp">ご提供いたします。<br>
                        徹底した従業員教育のもと、運転、荷扱、マナー等の<br class="sp">サービス品質向上に日々努めております。
