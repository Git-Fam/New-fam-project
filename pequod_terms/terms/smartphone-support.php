...
<head prefix="og: https://ogp.me/ns#">
  ...
  $title = ' | ';
  $description = '';
  $url = '/terms/smartphone-support.php';
      ...
      <div class="wrap wrap-sp">
        ...
        <div class="terms">
          ...
          <div class="terms--container">
            ...
            <div class="terms--item">
              ...
              <div class="item-content">
                <div class="item-content-card">
                  <p>
                    サービス「スマホ安心サポート（以下「本サービス」といいます。）」に付随関連して、以下の表に記載された無線通信機能を内蔵した通信端末（以下「対象端末」といいます。）の破損・水濡れ等により生じた損害に関して、引受保険会社をさくら損害保険株式会社（以下「引受保険会社」といいます。）、保険契約者を株式会社pequod、被保険者を会員（会員が個人の場合に限り、生計を同一にする同居の親族（2親等以内）および別居の未婚の子を含みます。）とする通信端末修理費用保険契約に基づき、引受保険会社から保険金額を上限とする保険金が支払われる特典をいいます。
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="terms--item">
              ...
              <div class="item-content">
                <div class="item-content-card">
                  <p>
                    引受保険会社は、被保険者に以下「５．補償の範囲」の記載に応じて、対象端末に損害（修理費用・交換費用をいいます。）が生じた場合に、1被保険者あたり1年（起算日は本サービスの利用契約開始日の翌々月1日とします。）につき下記記載の金額を上限として、被保険者が被った実損金額を通信端末修理費用保険金としてお支払いします。但し、除外事項に該当する場合、保険金はお支払しないものとします。
                  </p>
                  <!-- テーブル -->
                  <table class="table-terms-type01">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td rowspan="3">
                          <p>修理可能：最大5万円（※2）</p>
                          <p>修理不能：最大1万2千5百円（※3）</p>
                        </td>
                        <td rowspan="3">
                          <p>保険金の支払回数は年1回まで（※4）</p>
                        </td>
                      </tr>
                      <tr>
                        <td>
                ...
                <div class="item-content-card">
                  ...
                  <ul>
                    ...
                    <li>
                      <p>
                        （※6）会員の同居の親族（2
                        親等以内）、または別居の未婚の子が所有、または使用する対象端末の請求に必要となります。なお、健康保険証を提出される場合は、表面・裏面の両方のコピーが必要となります。
                      </p>
                    </li>
                  </ul>
                </div>
          ...
          <div class="terms--info">
            ...
            <p>さくら損害保険 保険金請求窓口　 電話番号：0120-982-267</p>
