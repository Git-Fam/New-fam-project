              ...
              <div class="item-content">
                <div class="item-content-card">
                  ...
                  <ul>
                    ...
                    <li>
                      <p>
                        入庫、出庫は当社所定の宅配便のみにより行い、当社店頭での寄託物の引渡し、返還は行いません。                      </p>
                    </li>
                    <li>
                      <p>
                    ...
                    <li>
                      <p>
                        月額保管料は、毎月１日から当月末日までを１ヶ月間として計算します。なお、１か月間に満たない保管期間は１ヶ月間として計算します。
                      </p>
                    </li>
                  </ul>
                </div>
          ...
          <div class="terms--container">
              ...
              <div class="item-content">
                <div class="item-content-card">
                  <ul>
                    <li>
                      <p>
                        1.本規約は、株式会社pequod（以下、「当社」といいます。）がウォーターサーバーの相談窓口等のサービス(以下、「本サービス」といいます。)をご契約者様に対して提供する、「ウォーターサーバーの相談窓口」（以下、「本サイト」といいます。）について定めるものです。
                      </p>
                    </li>
                    <li>
                      <p>
            ...
            <div class="terms--item">
              ...
              <div class="item-content">
                <div class="item-content-card">
                  <p>
                    本サイトの運用にあたって、当社は当社指定の第三者にオペレーター業務及び相談ウォーターサーバーの相談窓口等の全ての業務を委託することができます。
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="item-content">
                <div class="item-content-card">
                  <ul>
                    ...
                    <li>
                      <p>
                        2.各メーカーのオペレーターによるウォーターサーバーの相談窓口
                      </p>
                    </li>
                  </ul>
                </div>
